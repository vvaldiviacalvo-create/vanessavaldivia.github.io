...
<h1 style="font-size: 2.2em; font-weight: bold; margin-bottom: 15px; color: #1f2937;">Vanessa Valdivia</h1>

<img src="foto.jpg" alt="Vanessa Valdivia" style="width: 170px; height: 170px; border-radius: 50%; object-fit: cover; margin: 0 auto 15px; display: block;">

<p style="font-size: 0.95em; color: #4b5563; line-height: 1.4;">
¡Hola! Te doy la bienvenida a mi portafolio de proyectos de Análisis de Datos.
</p>

<p style="margin-top: 15px;">
<a href="https://github.com/vvaldiviacalvo-create" target="_blank" style="font-weight: bold; font-size: 0.95em;">Ver mi perfil de GitHub</a>
</p>
